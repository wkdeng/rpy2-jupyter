...
# docker run -p 8888:8888 -d --rm -v /Users/wdeng3/CodeSpace:/Users/wdeng3/CodeSpace --platform linux/amd64 \
# dengwankun/bioinfo_env:jpt_svr jupyter notebook --ip=0.0.0.0 --no-browser --port=8888 --notebook-dir=/Users/wdeng3/CodeSpace --allow-root --NotebookApp.token='sirius123'
