...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_18.x 鈥� Node.js 18 \"Eighteen\"${normal} (current)
...
This script, located at ${bold}https://deb.nodesource.com/setup${normal}, used to
   ...
   * ${green}https://deb.nodesource.com/setup_14.x 鈥� Node.js 14 LTS \"Fermium\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_16.x 鈥� Node.js 16 \"Gallium\"${normal}
   * ${green}https://deb.nodesource.com/setup_17.x 鈥� Node.js 18 \"Eighteen\"${normal} (current)
